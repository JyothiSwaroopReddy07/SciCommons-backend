    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', cloudinary.models.CloudinaryField(max_length=255, null=True, verbose_name='profile_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_file', cloudinary.models.CloudinaryField(max_length=255, verbose_name='articles_file')),
                ...
                ('published_article_file', cloudinary.models.CloudinaryField(blank=True, max_length=255, verbose_name='published_article_file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(max_length=255, null=True, verbose_name='social_post_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('channel', models.CharField(blank=None, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('rejected', 'rejected'), ('accepted', 'accepted'), ('submitted', 'submitted'), ('in review', 'in review')], max_length=255)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('is_admin', True)), fields=('community', 'is_admin'), name='unique_admin_per_community'),
        ),
