# Generated by Django 4.2.3 on 2023-08-17 08:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('in review', 'in review'), ('accepted', 'accepted'), ('rejected', 'rejected'), ('submitted', 'submitted')], max_length=255)),
